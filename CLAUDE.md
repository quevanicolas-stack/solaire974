...
- Préréglage `naturel` : déduit d'une mesure, non d'un goût. Trois prises de la même voix comparées à une génération faite depuis elles (enveloppe cepstrale, calage 1–4 kHz) montrent que le moteur rend trop de bas-médium (+5 à +8 dB sous 600 Hz) et pas assez d'aigus (−7 à −10 dB au-dessus de 4 kHz). Les trois prises entre elles ne s'écartaient que de 1,8 dB : l'écart est celui du moteur. La chaîne ramène l'écart moyen de 5,3 à 1,6 dB, vérifié en calculant la réponse des filtres et en la reportant bande par bande. Ne pas la retoucher sans refaire cette mesure.
