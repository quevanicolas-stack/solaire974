...
- **Un réglage affiché doit agir.** Une fois le profil verrouillé, les curseurs du studio n'agissent plus — la génération reprend les valeurs du profil. Les laisser visibles et manipulables affichait donc une fausse information : `majVerrou()` masque `#blocReglagesProfil` dès que le profil est verrouillé, et le redonne en le rouvrant. `verifier.js` impose les deux sens.
