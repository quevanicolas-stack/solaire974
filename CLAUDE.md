...
- Sur le serveur local, **`similarity_boost`, `style` et `use_speaker_boost` ne sont lus par aucun moteur** : ce sont des paramètres du service distant. La page le dit sous chaque réglage quand le fournisseur est local. Les laisser passer pour actifs poussait à les régler pour rien.
