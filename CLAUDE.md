...
- `calculerCorrection` a besoin de la version **non traitée**, seule à décrire le moteur seul. Elle la prend dans la génération en cours, à défaut dans une entrée chargée en « non traitée ». Sans l'une ni l'autre, elle le dit au lieu de comparer n'importe quoi.
